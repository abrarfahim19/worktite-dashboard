    ...
    PROTECTED: {
        ...
        GENERAL: {
            APPOINTMENTS: {
                ...
                PATHCH: (id: string | number) => `/general/api/v1/protected/appointment/${id}/`,
                GET: (id: string | number) => `/general/api/v1/protected/appointment/${id}/`,
                DELETE: (id: string | number) => `/general/api/v1/protected/appointment/${id}/`,
            },
            MEETINGS: {
                GET: (id: string | number) => addQueryParams(`/general/api/v1/protected/meeting/${id}/`),
            ...
            CALENDER: {
                APPOINTMENTS: {
                    LIST: addQueryParams("/general/api/v1/protected/calender/appointments/")
                },
                MEETINGS: {
